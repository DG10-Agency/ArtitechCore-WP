                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="artitechcore-schema-actions">
                                        <?php if (!$has_enhancement): ?>
                                            <a href="<?php echo esc_url(admin_url('admin.php?page=artitechcore-main&tab=enhancer&action=generate_ce&post=' . $p->ID) . '&_wpnonce=' . wp_create_nonce('generate_ce_' . $p->ID)); ?>" class="button button-small">Generate</a>
                                        <?php else: ?>
