    ...
    public function debug_service_detection() {
        ...
        if (!empty($service_pages)) {
            ...
            foreach ($organized_services as $category => $services) {
                ...
                echo "<ul>";
                foreach ($services as $service) {
                    echo "<li><strong>{$service->post_title}</strong> - <a href='" . esc_url(get_permalink($service->ID)) . "' target='_blank'>View</a></li>";
                }
                echo "</ul>";
            }
        } else {
    ...
    public function debug_resource_detection() {
        ...
        if (!empty($organized_resources)) {
            foreach ($organized_resources as $category => $pages) {
                ...
                echo "<ul>";
                foreach ($pages as $page) {
                    echo "<li><strong>{$page->post_title}</strong> - <a href='" . esc_url(get_permalink($page->ID)) . "' target='_blank'>View</a></li>";
                }
                echo "</ul>";
            }
        } else {
